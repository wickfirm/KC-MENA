...
const details: Record<BusinessDetailSlug, BusinessDetailContent> = {
  ...
  "real-estate": {
    ...
    sections: [
      { eyebrow: "Investment & Asset Management", heading: "This is not a listings business. It is an investment business.", body: "Kasumigaseki MENA identifies inefficiencies in product, location, pricing, and timing. The current Dubai portfolio spans high-performing districts including Downtown, Dubai Hills, Hartland, and Palm Jumeirah.", image: "/images/reference/real-estate-hero.webp" },
      { eyebrow: "Why Dubai, Why Now", heading: "The thesis is built on growth, liquidity, and international relevance.", body: "The long-term market case is supported by continued population growth, infrastructure expansion, Dubai's 2040 urban master plan, and globally mobile investors seeking security, connectivity, and a tax-efficient base.", image: "/images/reference/real-estate-hero.webp" },
      { eyebrow: "Platform Role", heading: "The proposition is built around access, discipline, and market logic.", body: "The business supports more than acquisition: it covers sourcing, underwriting, financial modeling, transaction support, asset strategy after closing, repositioning, leasing logic, resale preparation, and development planning.", image: "/images/reference/real-estate-hero.webp" },
    ],
  },
  "f-and-b": {
    version: 1,
    ...
    sections: [
      { eyebrow: "Food & Beverage", heading: "Authentic Japanese dining, translated for Dubai without diluting the craft.", body: "Kasumigaseki Restaurant is positioned as a Japanese dining experience brought from Tokyo to a global audience. The concept blends disciplined technique with a contemporary expression, giving Dubai a restaurant that feels both premium and current.", image: "/images/reference/fnb-hero.webp" },
      { eyebrow: "Chef & Menu", heading: "The kitchen is led by chef Keigo Abe.", body: "With Michelin-selected recognition in Tokyo, the menu moves across seasonal ingredients, charcoal-fired dishes, omakase-inspired moments, and plates designed for both discovery and repeat visits.", image: "/images/reference/fnb-hero.webp" },
      { eyebrow: "Dubai Positioning", heading: "The concept wins because food, room, and service are all aligned.", body: "The Food & Beverage business is built around craft, atmosphere, and memorability: credible technique, luxury without noise, and a setting designed for destination dining and repeat business.", image: "/images/reference/fnb-hero.webp" },
    ],
  },
  "global-businesses": {
    version: 1,
