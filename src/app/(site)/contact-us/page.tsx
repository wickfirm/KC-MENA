...
export default async function ContactPage() {
  ...
  return <main><section className="hero-band" style={{ "--hero-image": "url('/images/office.webp')" } as React.CSSProperties}><div className="wrap"><h1>{content.heroTitle}</h1></div></section>
    ...
    <section className="section" style={{ background: "var(--grey-1)" }}><div className="wrap" style={{ maxWidth: 820 }}><span className="eyebrow">{content.enquiryEyebrow}</span><h2 style={{ marginTop: 12 }}>{content.enquiryHeading}</h2><p style={{ marginTop: 12 }}>{content.enquiryBody}</p><a className="btn btn-solid" href="mailto:info.dubai@kasumigaseki.co.jp" style={{ marginTop: 22 }}>Email our team</a><p style={{ marginTop: 12, color: "var(--grey-5)", fontSize: ".86rem" }}>Enquiries currently open your email client; CRM submission is scheduled for Phase 3.</p></div></section>
  </main>;
}
