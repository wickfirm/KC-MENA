...
const navItems = [
  ...
  { href: "/admin/site/home", label: "Home page" },
  { href: "/admin/site/about", label: "About Us" },
  { href: "/admin/site/local-business", label: "Local Business" },
  { href: "/admin/site/business/real-estate-development", label: "Development" },
